...
int _habitEstimateSize(
  ...
  bytesCount += 3 + object.comletedDays.length * 8;
...
void _habitSerialize(
  ...
  writer.writeDateTimeList(offsets[0], object.comletedDays);
...
Habit _habitDeserialize(
  ...
  final object = Habit();
  object.comletedDays = reader.readDateTimeList(offsets[0]) ?? [];
  object.id = id;
...
extension HabitQueryFilter on QueryBuilder<Habit, Habit, QFilterCondition> {
  QueryBuilder<Habit, Habit, QAfterFilterCondition> comletedDaysElementEqualTo(
      DateTime value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'comletedDays',
        value: value,
      ));
    });
  }
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition>
      comletedDaysElementGreaterThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> comletedDaysElementLessThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> comletedDaysElementBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> comletedDaysLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> comletedDaysIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'comletedDays',
        0,
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> comletedDaysIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'comletedDays',
        0,
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> comletedDaysLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Habit, Habit, QAfterFilterCondition> comletedDaysLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension HabitQueryWhereDistinct on QueryBuilder<Habit, Habit, QDistinct> {
  QueryBuilder<Habit, Habit, QDistinct> distinctByComletedDays() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'comletedDays');
    });
  }
...
extension HabitQueryProperty on QueryBuilder<Habit, Habit, QQueryProperty> {
  ...
  QueryBuilder<Habit, List<DateTime>, QQueryOperations> comletedDaysProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'comletedDays');
    });
  }
